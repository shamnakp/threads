...
const updateMongoWallet = async (req, res) => {
  try {
    ...
    console.log(
      "Error happened in the wallet ctrl in the function updateMongoWallet",
      error
    );
    res
      .status(500)
      .json({ message: "An error occurred while updating the wallet", error });
  }
};

//----------------walet  transaction use the wallet =====
const sumWallet = async (req, res) => {
  try {
    ...
    console.log(
      "Error happened in the wallet ctrl in the function sumWallet",
      error
    );
  }
};
...
const sumWalletBuynow = async (req, res) => {
  try {
    const coupon = await Coupon.find();
    ...
    console.log(
      "Error happened in the wallet ctrl in the function sumWalletBuynow",
      error
    );
  }
};
